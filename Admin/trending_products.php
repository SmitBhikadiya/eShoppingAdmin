...
$totalRecords = $obj->TotalTrendingProducts($search);
$products = $obj->getTrendingProducts($search,(($currntPage - 1) * $showRecords), $showRecords);
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
					<h2 class="mt-30 page-title">Trending Products</h2>
					<ol class="breadcrumb">
