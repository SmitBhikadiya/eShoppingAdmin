...
$totalRecords = $obj->TotalNewsLetter($search);
$letters = $obj->getNewsLetter($search,(($currntPage - 1) * $showRecords), $showRecords);
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h2 class="mt-30 page-title">News Letters</h2>
                    <ol class="breadcrumb">
                    ...
                    <nav class="navbar navbar-light bg-light justify-content-between">
                        <a href="add_newsletter.php" class="add-btn hover-btn">Add New</a>
                        <div class="form-inline">
                            <input class="form-control mr-sm-2" type="search" placeholder="Search By title" aria-label="Search" value="<?= $search ?>">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $letter["createdDate"] ?></td>
                                                            <td><?= $letter["modifiedDate"] ?></td>
                                                            <td class="action-btns">
                                                            <a href="add_newsletter.php?edit=<?= $letter["id"] ?>" style="cursor: pointer;" class="edit-btn"><i class="fas fa-edit"></i></a>&nbsp;
                                                                <a href="./handler/requestHandler.php?dNewsletter=<?= $letter["id"] ?>" style="cursor: pointer;" class="edit-btn deleteRow"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                <?php
                                                    }
