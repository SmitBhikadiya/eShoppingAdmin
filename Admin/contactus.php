<?php
session_start();
require("./handler/contactusHandler.php");
$obj = new ContactUsHandler();
...
$totalRecords = $obj->TotalContact($search);
$contacts = $obj->getAllContacts($search,(($currntPage - 1) * $showRecords), $showRecords);
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h2 class="mt-30 page-title">All Contacts</h2>
                    <ol class="breadcrumb">
                    ...
                    <nav class="navbar navbar-light bg-light justify-content-between">
                        ...
                        <div class="form-inline">
                            <input class="form-control mr-sm-2" type="search" placeholder="Search By email, name, subject" aria-label="Search" value="<?= $search ?>">
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td class="action-btns">
                                                                ...
                                                                <a href="./handler/requestHandler.php?dContact=<?= $contact["id"] ?>" style="cursor: pointer;" class="edit-btn deleteRow"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                <?php
                                                    }
