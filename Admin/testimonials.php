...
$totalRecords = $obj->TotalTestimonial($search);
$testies = $obj->getTestimonials($search, (($currntPage - 1) * $showRecords), $showRecords);
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
					<h2 class="mt-30 page-title">Testimonial</h2>
					<ol class="breadcrumb">
					...
					<nav class="navbar navbar-light bg-light justify-content-between">
						<a href="add_testimonial.php" class="add-btn hover-btn">Add New</a>
											...
											<tbody>
												...
												?>
														<tr>
															...
															<td>
																	<?php
																	if($testi["reviewerImage"]=='' || $testi["reviewerImage"]==null){
																	?>
																		<img src="images/noimage.jpg" style="border: 1px solid red;" alt="noimage" height="60">
																	<?php
																	}else{
																	?>
																		<img src="images/testimonials/<?=$testi["reviewerImage"]?>" height="60" alt='<?=$testi["reviewerImage"]?>' />
																	<?php
																	} 
																	?>	
															</td>
															<td><?= $testi["reviewerName"] ?></td>
															<td><?= $testi["reviewerProfession"] ?></td>
															<td><?= $testi["review"] ?></td>
															<td><?= $testi["createdDate"] ?></td>
															<td><?= $testi["modifiedDate"] ?></td>
															<td class="action-btns">
																<a href="add_testimonial.php?edit=<?= $testi["id"] ?>" class=" edit-btn"><i class="fas fa-edit"></i></a>
																<a href="./handler/requestHandler.php?dTestimonial=<?= $testi["id"] ?>" class="edit-btn deleteRow"><i class="fas fa-trash"></i></a>
															</td>
														</tr>
												<?php
													}
