...
$totalRecords = $obj->TotalBanner($search);
$banners = $obj->getBanners($search, (($currntPage - 1) * $showRecords), $showRecords);
		...
		<div id="layoutSidenav_content">
			<main>
				<div class="container-fluid">
					<h2 class="mt-30 page-title">Home Banners</h2>
					<ol class="breadcrumb">
					...
					<nav class="navbar navbar-light bg-light justify-content-between">
						<a href="add_banner.php" class="add-btn hover-btn">Add New</a>
											...
											<tbody>
												...
												?>
														<tr>
															...
															<td>
																	<?php
																	if($banner["bannerImageURL"]=='' || $banner["bannerImageURL"]==null){
																	?>
																		<img src="images/noimage.jpg" style="border: 1px solid red;" alt="noimage" height="60">
																	<?php
																	}else{
																	?>
																		<img src="images/banners/<?=$banner["bannerImageURL"]?>" height="60" alt='<?=$banner["bannerImageURL"]?>' />
																	<?php
																	} 
																	?>
															</td>
															<td><?= $banner["createdDate"] ?></td>
															<td><?= $banner["modifiedDate"] ?></td>
															<td class="action-btns">
																<a href="add_banner.php?edit=<?= $banner["id"] ?>" class="edit-btn"><i class="fas fa-edit"></i></a>
																<a href="./handler/requestHandler.php?dBanner=<?= $banner["id"] ?>" class="edit-btn deleteRow"><i class="fas fa-trash"></i></a>
															</td>
														</tr>
												<?php
													}
