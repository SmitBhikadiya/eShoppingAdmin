...
$totalRecords = $obj->TotalColors($search);
$colors = $obj->getColors($search, (($currntPage - 1) * $showRecords), $showRecords);
            ...
            <main>
                <div class="container-fluid">
                    ...
                    <nav class="navbar navbar-light bg-light justify-content-between">
                        <a href="add_color.php" class="add-btn hover-btn">Add New</a>
