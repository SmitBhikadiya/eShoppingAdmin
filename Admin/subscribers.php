...
$totalRecords = $obj->TotalNewsLetterSubscriber($search);
$subscribers = $obj->getNewsLetterSubscriber($search,(($currntPage - 1) * $showRecords), $showRecords);
        ...
        <div id="layoutSidenav_content">
            <main>
                <div class="container-fluid">
                    <h2 class="mt-30 page-title">News Subscribers</h2>
                    <ol class="breadcrumb">
                        <li class="breadcrumb-item">
                            <a href="index.php">Dashboard</a>
                        </li>
                        <li class="breadcrumb-item active">News Subscribers</li>
                    </ol>
                    ...
                    <nav class="navbar navbar-light bg-light justify-content-between">
                        ...
                        <div class="form-inline">
                            <input class="form-control mr-sm-2" type="search" placeholder="Search By email" aria-label="Search" value="<?= $search ?>">
                                            ...
                                            <tbody>
                                                ...
                                                ?>
                                                        <tr>
                                                            ...
                                                            <td><?= $subscriber["modifiedDate"] ?></td>
                                                            <td class="action-btns">
                                                                <a href="./handler/requestHandler.php?dSubscriber=<?= $subscriber["id"] ?>" style="cursor: pointer;" class="edit-btn deleteRow"><i class="fas fa-trash"></i></a>
                                                            </td>
                                                        </tr>
                                                <?php
                                                    }
