...
if (isset($_POST["username"]) && isset($_POST["password"])) {
  ...
  if ($res['error'] == '') {
    $res['error'] = sendEmailForRegister($email, 'Registration Successfully!!', $username);
  }else{
    unlink($target);
  }
...
function sendEmailForRegister($email, $subject, $username)
{
                      ...
                      <div class="Scriptcontent">    
                            <div id="card" class="animated fadeIn">
                                <div id="upper-side">
                                    ...
                                    <h3 id="status">Hello, ' . $username . '</h3>
                                </div>
                                <div id="lower-side">
                                    <p id="message">
                                      Congratulations, your account has been successfully created.
                                    </p>
                                    <a href="http://localhost:4200/" id="contBtn">Continue</a>
                                </div>
                            </div>
                        </div>
                    </div>
